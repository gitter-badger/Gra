			...
			<div class="navbar-header navbar-left">
				...
				<div class="navbar-right">
					<p class="navbar-text">
						...
						<span class="badge level" title="@lang('player.level')">{{ $player->level }}</span>
						<span class="badge plantator-level" title="@lang('player.plantatorLevel')">{{ $player->plantatorLevel }}</span>
						<span class="badge smuggler-level" title="@lang('player.smugglerLevel')">{{ $player->smugglerLevel }}</span>
						<span class="badge dealer-level" title="@lang('player.dealerLevel')">{{ $player->dealerLevel }}</span>
					</p>
					<p class="navbar-text money" title="@lang('player.money')">{{ Formatter::money($player->money) }}</p>
					<p class="navbar-text" title="@lang('player.premiumPoints')">{{ $player->premiumPoints }}pp</p>
					<p class="navbar-text luck" title="@lang('player.luck')">{{ $player->luck }}%</p>
				</div>
			</div>
