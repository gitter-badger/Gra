...
use AdamWathan\Form\Elements\Image;
use AdamWathan\Form\Elements\File;
use AdamWathan\Form\Elements\Date;
use AdamWathan\Form\Elements\Duration;
use AdamWathan\Form\Elements\Email;
use AdamWathan\Form\Elements\Number;
use AdamWathan\Form\Elements\Range;
use AdamWathan\Form\Elements\StaticInput;
...
class FormBuilder
{
    ...
    public function staticInput()
    {
        $static = new StaticInput;
